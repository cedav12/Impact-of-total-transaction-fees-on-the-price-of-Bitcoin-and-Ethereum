...
parser.add_argument("--asset", default="addresses/", type=str, help="Specify section.")
parser.add_argument("--endpoint", default="active_count", type=str, help="Specify endpoint to load data from.")
...
parser.add_argument("--col_name", default="active_addresses", type=str, help="Name the new column.")
parser.add_argument("--save_file", default="btc_active_addresses.csv", type=str,
